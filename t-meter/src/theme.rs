...
pub fn get_ocean_theme() -> Theme {
    Theme {
        ...
        light: ColorScheme {
            ...
            progress_filled: Color::Rgb(0, 153, 204),
        ...
        dark: ColorScheme {
            ...
            progress_filled: Color::Rgb(51, 153, 255),
...
pub fn get_forest_theme() -> Theme {
    Theme {
        ...
        light: ColorScheme {
            ...
            progress_filled: Color::Rgb(50, 205, 50),
        ...
        dark: ColorScheme {
            ...
            progress_filled: Color::Rgb(34, 139, 34),
...
pub fn get_sunset_theme() -> Theme {
    Theme {
        ...
        light: ColorScheme {
            ...
            progress_filled: Color::Rgb(255, 140, 0),
        ...
        dark: ColorScheme {
            ...
            progress_filled: Color::Rgb(255, 99, 71),
...
pub fn get_monochrome_theme() -> Theme {
    Theme {
        ...
        light: ColorScheme {
            ...
            title: Color::Black,
            progress_filled: Color::Rgb(64, 64, 64),
            progress_empty: Color::Rgb(224, 224, 224),
            progress_indicator: Color::Rgb(128, 128, 128),
            marker: Color::Rgb(64, 64, 64),
            marker_label: Color::Rgb(32, 32, 32),
            quote: Color::Rgb(128, 128, 128),
            legend_elapsed: Color::Rgb(64, 64, 64),
            legend_remaining: Color::Rgb(192, 192, 192),
        },
        dark: ColorScheme {
            background: None,
            foreground: Color::White,
            title: Color::White,
            progress_filled: Color::Rgb(192, 192, 192),
            progress_empty: Color::Rgb(64, 64, 64),
            progress_indicator: Color::Rgb(160, 160, 160),
            marker: Color::Rgb(192, 192, 192),
            marker_label: Color::Rgb(224, 224, 224),
            quote: Color::Rgb(128, 128, 128),
            legend_elapsed: Color::Rgb(192, 192, 192),
            legend_remaining: Color::Rgb(96, 96, 96),
        },
    }
}
